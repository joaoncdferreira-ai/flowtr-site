...
export const siteCopy = {
  pt: {
    ...
    hero: {
      eyebrow: "A caminho da App Store",
      ...
      primary: "Avisa-me no lançamento",
      secondary: "Como funciona",
      status: ["iPhone primeiro", "Android a seguir", "Grátis · sem anúncios"],
    ...
    gallery: {
      ...
      description:
        "Ecrãs da versão atual: mapa, revisão da corrida, Diário, rankings, desafios e partilha.",
      badgeIntro: "Emblemas desbloqueados a correr",
      shots: [
        { caption: "Mapa", alt: "Mapa 3D atual da Flowtr" },
        {
          caption: "Revisão",
          alt: "Revisão de uma corrida com um percurso fechado na Flowtr",
        },
        { caption: "Diário", alt: "Diário de corridas e conquistas da Flowtr" },
        { caption: "Rankings", alt: "Ranking de corredores da Flowtr" },
        { caption: "Desafios", alt: "Lista de desafios entre corredores na Flowtr" },
        { caption: "Partilha", alt: "Vídeo de corrida pronto a partilhar" },
      ],
      badges: [
        {
          name: "Primeiro passo",
    ...
    waitlist: {
      eyebrow: "Lançamento nas lojas",
      title: "Queres saber",
      highlight: "quando sair?",
      description:
        "A versão para iPhone sai primeiro; a de Android vem depois. Deixa o email e avisamos-te quando a Flowtr estiver disponível.",
      ...
      note: "Apenas informação sobre o lançamento. Sem publicidade.",
    },
    footer: {
  ...
  en: {
    ...
    hero: {
      ...
      status: ["iPhone first", "Android next", "Free · no ads"],
      conquered: "CLAIMED",
      videoLabel:
    ...
    stat: [
      ...
      "APP STORE FIRST · GOOGLE PLAY NEXT",
    ...
    gallery: {
      ...
      description:
        "Current screens: map, run review, Diary, rankings, challenges and sharing.",
      badgeIntro: "Badges earned by running",
      shots: [
        { caption: "Map", alt: "Current Flowtr 3D map" },
        {
          caption: "Review",
          alt: "Run review with a closed route in Flowtr",
        },
        { caption: "Diary", alt: "Flowtr run and claim Diary" },
        { caption: "Rankings", alt: "Flowtr runner ranking" },
        { caption: "Challenges", alt: "Flowtr runner challenges" },
        { caption: "Share", alt: "Run video ready to share" },
      ],
      badges: [
    ...
    faq: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "We are preparing the App Store launch first. Android follows on Google Play. Leave your email and we will tell you when the right version is available.",
        },
      ],
    },
    waitlist: {
      ...
      title: "Want to know",
      highlight: "when it launches?",
      description:
        "iPhone launches first; Android comes next. Leave your email and we will tell you when Flowtr is available.",
      ...
      note: "Launch information only. No advertising.",
    },
    footer: {
  ...
  es: {
    ...
    hero: {
      eyebrow: "De camino a la App Store",
      headline: ["Corre.", "Conquista.", "Domina."],
      body:
        "Cierra un recorrido, reclama el área en el mapa e intenta conservarla. Otros corredores pueden conquistar lo que es tuyo.",
      primary: "Avísame en el lanzamiento",
      secondary: "Cómo funciona",
      status: ["iPhone primero", "Android después", "Gratis · sin anuncios"],
      conquered: "CONQUISTADO",
      videoLabel:
    ...
    stat: [
      ...
      "APP STORE PRIMERO · GOOGLE PLAY DESPUÉS",
    ...
    gallery: {
      ...
      description:
        "Pantallas actuales: mapa, revisión de carrera, Diario, rankings, retos y opciones para compartir.",
      badgeIntro: "Insignias desbloqueadas corriendo",
      shots: [
        { caption: "Mapa", alt: "Mapa 3D actual de Flowtr" },
        {
          caption: "Revisión",
          alt: "Revisión de una carrera con un recorrido cerrado en Flowtr",
        },
        { caption: "Diario", alt: "Diario de carreras y conquistas de Flowtr" },
        { caption: "Rankings", alt: "Ranking de corredores de Flowtr" },
        { caption: "Retos", alt: "Lista de retos entre corredores en Flowtr" },
        { caption: "Compartir", alt: "Vídeo de carrera listo para compartir" },
      ],
      badges: [
    ...
    faq: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Primero estamos preparando el lanzamiento en la App Store. Android llegará después a Google Play. Déjanos tu email y te avisaremos cuando esté disponible la versión adecuada.",
        },
      ],
    },
    waitlist: {
      eyebrow: "Lanzamiento en las tiendas",
      title: "¿Quieres saber",
      highlight: "cuándo estará disponible?",
      description:
        "La versión para iPhone llegará primero; Android vendrá después. Déjanos tu email y te avisaremos cuando Flowtr esté disponible.",
      ...
      note: "Solo información sobre el lanzamiento. Sin publicidad.",
    },
    footer: {
